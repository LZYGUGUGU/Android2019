...
public class MainActivity extends AppCompatActivity {
    ...
    private void postVideo() {
        ...
        Call<returnsomething> call = getDouyinService().PostVideo("lzy",coverImagePart,videoPart);
        Log.d("postVideo","prepare_2");
        call.enqueue(new Callback<returnsomething>() {
            @Override
            public void onResponse(Call<returnsomething> call, Response<returnsomething> response) {
            ...
            @Override
            public void onFailure(Call<returnsomething> call, Throwable throwable) {
                Toast.makeText(MainActivity.this, "Response wrong" , Toast.LENGTH_SHORT).show();
            }
